...
JLabel jl6=new JLabel("Insert Companies");
jl6.setBounds(200,45,400,76);
jl6.setFont(new Font("Lucida Handwriting",Font.BOLD,29));
contentPane.add(jl6);

JLabel jl1=new JLabel("Company Name");
jl1.setBounds(500,155,350,50);
contentPane.add(jl1);
jtf1=new JTextField(25);
jtf1.setBounds(670,170,150,20);
contentPane.add(jtf1);

JLabel jl2=new JLabel("Country");
jl2.setBounds(500,207,350,50);
contentPane.add(jl2);
